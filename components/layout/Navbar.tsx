    ...
    <>
      <div className="fixed z-50 top-0 w-full bg-white">
        <nav className="container flex justify-between items-center z-20">
          ...
          <button className="hidden lg:block bg-primary-lime-green px-7 py-3 rounded-full text-neutral-white text-xs bg-gradient-to-r from-primary-lime-green to-primary-bright-cyan hover:button-brightness focus:outline-none focus:ring ring-emerald-400">
            Request Invite
          </button>
      ...
      {/* Modal */}
      <div
        className={`fixed inset-0 z-30 bg-gray-800/50 ${
          isOpen ? 'block' : 'hidden'
        }`}
      >
